    ...
    return (
        <div className={`${className ? className : ''} pb-24 overflow-hidden`}>
            <div className='ml-[18%]'>
                ...
                <p className='block mt-5 text-7xl font-bold text-white w-[50%]'>A new, easy way to create.</p>
            </div>
            <div className='cards-group flex flex-nowrap gap-5 justify-center relative'>
                <div className='wrapper flex-shrink-0 relative -top-20 w-64 perspective-1000'>
                ...
                <div className='flex-shrink-0 w-64 h-64 bg-figr-grey rounded-xl relative top-28'></div>
                <div className='wrapper flex-shrink-0 relative w-64 top-10'>
                ...
                <div className='flex-shrink-0 relative w-56 -top-56 perspective-1000'>
                ...
                <div className='wrapper flex-shrink-0 relative w-72'>
